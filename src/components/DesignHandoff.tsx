 ...
 *
 * **"누르면 저쪽에 디자인이 생긴다" 고 하지 않는다.** 스티치·Figma 에는 밖에서
 * 화면을 만들어 넣는 공개 API 가 없다. 있는 척하면 눌러 놓고 아무 일도 안 일어나는
 * 것을 사용자가 겪게 된다.
 *
 * 대신 **손으로 옮겨 적는 일을 없앤다.** 화면마다 무엇을 그려야 하는지는 이미
      ...
      <div className="flex flex-col gap-3.5">
        ...
        */}
        <div className="flex items-start gap-2 text-[11.5px] leading-relaxed text-[var(--fg-subtle)]">
          ...
          <p className="min-w-0">
            이 도구들에는 밖에서 화면을 만들어 넣는 공개 API 가 없어, 눌러서 저쪽에 바로 만드는 것은
            아직 어느 서비스도 지원하지 않습니다. 대신 옮겨 적는 일이 없도록 요청문을 대신 써 둡니다.
