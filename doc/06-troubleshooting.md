...
### AI 가 만든 내용이 마음에 들지 않음

- 위저드의 **서비스 아이디어**를 더 구체적으로 적고 다시 생성해 보세요.
  타겟·목적·필수 기능까지 채우면 결과가 크게 달라집니다.
- 특정 항목만 고치고 싶다면 **AI 에이전트 패널**에서 대상 항목을 선택하고 요청하세요.
- 다시 생성하면 기존 내용을 덮어씁니다. 아깝다면 먼저 개요에서 **버전을 저장**하세요.
